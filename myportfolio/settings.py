...
SECRET_KEY = 'django-insecure-#yl7d%v3p#ab!mmll5d@=e#@kblu!lorhttf!=5)0hj1_l@ncl'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Adjust 'static' as per your folder structure
]
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "images/login_logo.jpg",
    "site_brand": "CC",
