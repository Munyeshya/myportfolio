export const profile = {
  ...
  metrics: [
    ...
    { value: '4', label: 'Core domains delivered across web, mobile, API, and ops' },
  ...
  education: [
    {
      school: 'Kigali Independent University',
      period: '2022 - 2026',
...
export const certifications = [
  {
    title: 'Industrial Based Training Certificate',
    organization: 'Rwanda TVET Board / IDA Technology',
    year: '2024',
    file: '/assets/Certa.pdf',
  },
  {
    title: 'Resume PDF',
    organization: 'Career Document',
    year: '2026',
    file: '/assets/MUNYESHYA_Beni_Obed_Resume.pdf',
  },
]
