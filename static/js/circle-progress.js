function animationEndEventName() {
    ...
    for (t in n)
        if (n.hasOwnProperty(t) && void 0 !== e.style[t])
            return n[t]
}
!function (t) {
    ...
    return function t(e, n, r) {
                ...
                var r = function () {
                    ...
                    function v(t, e, n, r, i, u, f, p, c) {
                        o = e + n,
                            s = Math.min(l(), o),
                            a = s >= o,
                            t.isPlaying() && !a ? (c(t._timeoutHandler, h),
                                m(t, "beforeTween"),
                                _(s, r, i, u, n, e, f),
                                m(t, "afterTween"),
                                p(r)) : a && (p(u),
                    ...
                    return i = "undefined" != typeof window && (window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || window.mozCancelRequestAnimationFrame && window.mozRequestAnimationFrame) || setTimeout,
                        ...
                        x.prototype.setConfig = function (t) {
                            ...
                            return g(n, e),
                                ...
                                this._filterArgs = [e, this._originalState, n, this._easing],
                                m(this, "tweenCreated"),
                                this
                        }
                        ,
                        ...
                        x.prototype.stop = function (t) {
                            return this._isTweening = !1,
                                ...
                                t && (d(this._currentState, this._targetState),
                        ...
                        "object" == typeof n ? e.exports = x : void 0 === t.Tweenable && (t.Tweenable = x),
                        x
                }();
                    ...
                    function () {
                        ...
                        t._filterArgs = [],
                            r.interpolate = function (e, n, i, o) {
                                ...
                                return r.applyFilter(t, "afterTween"),
                                    d
                            }
                    }(),
                    function (t) {
                            ...
                            return t.each(r, function (t) {
                                ...
                                if ("string" == typeof h) {
                                    ...
                                    i[t] = {
                                        formatString: (o = h,
                                            s = o.match(n),
                                            s ? (1 === s.length || o[0].match(e)) && s.unshift("") : s = ["", ""],
                                            s.join(a)),
                ...
                , s = function t(e, n) {
                    ...
                    if (0 !== arguments.length) {
                        ...
                        this._container = o,
                            ...
                            this.text = null,
                            this._opts.text.value && (this.text = this._createTextElement(this._opts, this._container),
            ...
            s.prototype.animate = function (t, e, n) {
                ...
                s.prototype.setText = function (t) {
                    if (null === this._progressPath)
                        throw new Error(o);
                    if (null === this.text)
                        return this.text = this._createTextElement(this._opts, this._container),
                ...
                s.prototype._createTextElement = function (t, e) {
                    ...
                    return n.appendChild(document.createTextNode(t.text.value)),
                        t.text.autoStyle && (e.style.position = "relative",
                            ...
                            t.text.color ? n.style.color = t.text.color : n.style.color = t.color),
        ...
        8: [function (t, e, n) {
            ...
            function o(t) {
                return e = t,
                    "[object Array]" !== Object.prototype.toString.call(e) && ("object" === typeof t && !!t);
                var e
            }
            e.exports = {
        ...
        Array.prototype.forEach.call(t, function (e, n) {
            ...
            r = $(e).hasClass("progress-line") ? new ProgressBar.Line(t[n], {
                ...
                $(e).bind("inview", function (t, n) {
                    n && ($(e).hasClass("active") || (r.animate(i / 100),
                        $(e).addClass("active")))
                })
        })
    });
