...
+function (a) {
    ...
    function b(b) {
        return this.each(function () {
            ...
            (f || "destroy" != b) && (f || d.data("bs.validator", f = new c(this, e)),
                "string" == typeof b && f[b]())
        })
    }
    var c = function (b, d) {
        this.$element = a(b),
            this.options = d,
            d.errors = a.extend({}, c.DEFAULTS.errors, d.errors);
    ...
    c.INPUT_SELECTOR = ':input:not([type="submit"], button):enabled:visible',
        ...
        c.prototype.runValidators = function (b) {
            ...
            return b.data("bs.validator.deferred") && b.data("bs.validator.deferred").reject(),
                ...
                a.each(c.VALIDATORS, a.proxy(function (a, c) {
                ...
                !e.length && b.val() && b.data("remote") ? this.defer(b, function () {
                    var c = {};
                    c[b.attr("name")] = b.val(),
                        a.get(b.data("remote"), c).fail(function (a, b, c) {
                            e.push(d("remote") || c)
                        }).always(function () {
                            f.resolve(e)
                        })
        ...
        c.prototype.validate = function () {
            ...
            return this.options.delay = 0,
                this.$element.find(c.INPUT_SELECTOR).trigger("input.bs.validator"),
